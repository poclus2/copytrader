//+------------------------------------------------------------------+
//|                                   GoldSniperEA_PropFirm.mq5      |
//|                    PropFirm-Optimized Gold Trading EA             |
//|                    FTMO / MFF / E8 Compliant                      |
//+------------------------------------------------------------------+
#property copyright "Copyright 2024"
#property link      ""
#property version   "2.00 PropFirm Edition"
#property strict
...
input int      Min_Confirmations = 5;           // Minimum confirmations [SNIPER: 7->5]
...
input int      London_Session_Start = 9;        // London session start time (Client Time) [09:00]
input int      London_Session_End = 13;         // London session end time (Client Time) [13:00]
input bool     Trade_NewYork_Session = false;   // Trade in New York session [DISABLED]
...
input bool     Trade_Tokyo_Session = false;     // Trade in Tokyo session [DISABLED]
...
input double   Daily_Profit_Target_Pct = 1.5;           // Daily profit target % (stop if reached)
...
input int      News_Buffer_Minutes = 30;                // Minutes before/after news to avoid
...
input double   PropFirm_Risk_Per_Trade = 0.5;           // Max risk per trade % (ultra-conservative)
input int      PropFirm_Max_Positions = 1;              // Max simultaneous positions
