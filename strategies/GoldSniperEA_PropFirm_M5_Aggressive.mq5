//+------------------------------------------------------------------+
//|                       GoldSniperEA_PropFirm_M5_Aggressive.mq5    |
//|                    M5 ULTRA-AGGRESSIVE PropFirm Edition           |
//|                    FTMO / MFF / E8 - HIGH FREQUENCY MODE          |
//+------------------------------------------------------------------+
#property copyright "Copyright 2024"
#property link      ""
#property version   "2.10 M5 Aggressive"
#property strict
...
input int      Max_Positions = 3;               // Maximum number of open positions [M5: 3 positions]
input int      Max_Simultaneous_Trades = 3;     // Maximum number of simultaneous trades [M5: 3]
input int      Min_Confirmations = 2;           // Minimum confirmations [M5 AGGRESSIVE: 2]
...
input double   PropFirm_Risk_Per_Trade = 1.0;           // Max risk per trade % [M5 AGGRESSIVE: 1%]
input int      PropFirm_Max_Positions = 3;              // Max simultaneous positions [M5: 3]
